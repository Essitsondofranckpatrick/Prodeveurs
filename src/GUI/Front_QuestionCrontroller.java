...
id_question_apartir_quiz=questonss.get(indicequestions).getId_question();
                nodes_quess[indicequestions] = FXMLLoader.load(getClass().getResource("Item_Question.fxml"));
...
@FXML
    private void handleClicks(ActionEvent event) throws IOException {
           if (event.getSource() == btn_Quiz) {
            ...
            stage.close();
            Scene scene = new Scene(FXMLLoader.load(getClass().getResource("Front_Quiz.fxml")));
