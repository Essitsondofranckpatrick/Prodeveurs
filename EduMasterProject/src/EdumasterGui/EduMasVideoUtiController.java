...
public class EduMasVideoUtiController implements Initializable {
 ...
 String s=comb.getSelectionModel().getSelectedItem().toString();
        if (s=="Maths"){
        String path = new File("C:/Users/dell/Prodeveurs/EduMasterProject/src/Videos/foufou.mp4").getAbsolutePath();
        Media media = new Media(new File(path).toURI().toString());
        mediaPlayer = new MediaPlayer(media);
        MediaView.setMediaPlayer(mediaPlayer);
        mediaPlayer.setAutoPlay(true);}
        else if(s=="Francais")
        {String path = new File("C:/Users/dell/Prodeveurs/EduMasterProject/src/Videos/francais.mp4").getAbsolutePath();
        Media media = new Media(new File(path).toURI().toString());
        mediaPlayer = new MediaPlayer(media);
        MediaView.setMediaPlayer(mediaPlayer);
        mediaPlayer.setAutoPlay(true);
        ...
        String path = new File("C:/Users/dell/Prodeveurs/EduMasterProject/src/Videos/anglais.mp4").getAbsolutePath();
        Media media = new Media(new File(path).toURI().toString());
        mediaPlayer = new MediaPlayer(media);
        MediaView.setMediaPlayer(mediaPlayer);
        mediaPlayer.setAutoPlay(true);}
         else if(s=="Science") {
        String path = new File("C:/Users/dell/Prodeveurs/EduMasterProject/src/Videos/science.mp4").getAbsolutePath();
        Media media = new Media(new File(path).toURI().toString());
        mediaPlayer = new MediaPlayer(media);
        MediaView.setMediaPlayer(mediaPlayer);
        mediaPlayer.setAutoPlay(true);}
